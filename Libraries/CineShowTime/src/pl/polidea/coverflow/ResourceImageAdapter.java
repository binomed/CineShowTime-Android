...
/**
 * This class is an adapter that provides images from a fixed set of resource ids. Bitmaps and ImageViews are kept as weak references so that they can be cleared by garbage collection when not needed.
 * 
 */
