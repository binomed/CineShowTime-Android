...
public class ReflectingImageAdapter extends AbstractCoverFlowImageAdapter {
	...
	protected Bitmap createBitmap(final int position) {
		return createReflectedImages((Bitmap) linkedAdapter.getItem(position));
	}
	...
	public Bitmap createReflectedImages(final Bitmap originalImage) {
		...
		final LinearGradient shader = new LinearGradient(0, originalImage.getHeight(), 0, bitmapWithReflection.getHeight() + reflectionGap, 0x70ffffff, 0x00ffffff, TileMode.CLAMP);
