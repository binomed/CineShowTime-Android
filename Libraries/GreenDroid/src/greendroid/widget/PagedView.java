...
/**
 * <p>
 * A {@link View} that shows items in a "paged" manner. Pages can be scrolled horizontally by swiping the {@link View}. The {@link PagedView} uses a reuse mechanism similar to the one used by the {@link ListView}. Pages come from a {@link PagedAdapter}.
 * </p>
 * <p>
 * Clients may listen to {@link PagedView} changes (scrolling, page change, etc.) using an {@link OnPagedViewChangeListener} .
 * </p>
 * <p>
...
public class PagedView extends ViewGroup {
	...
	/**
	 * Clients may listen to changes occurring on a {@link PagedView} via this interface.
	 * 
	 * @author Cyril Mottier
	 */
	public interface OnPagedViewChangeListener {
		 ...
		 * 
		 * @param pagedView
		 *            The {@link PagedView} that changed its current page
		 * @param previousPage
		 *            The previous selected page
		 * @param newPage
		 *            The new selected
		 */
		 ...
		 * 
		 * @param pagedView
		 *            The {@link PagedView} the user started to track.
		 */
		 ...
		 * 
		 * @param pagedView
		 *            The {@link PagedView} the user ended to track.
		 */
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			mStartMotionX = x;
			/*
			 * If currently scrolling and user touches the screen, initiate drag; otherwise don't. mScroller.isFinished should be false when being flinged.
			 */
