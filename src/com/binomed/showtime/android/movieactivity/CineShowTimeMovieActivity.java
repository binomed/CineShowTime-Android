...
public class CineShowTimeMovieActivity extends TabActivity //
		...
		, OnCancelListener //
{
	...
	public void openDialog() {
		progressDialog = ProgressDialog.show(CineShowTimeMovieActivity.this,
		//
				CineShowTimeMovieActivity.this.getResources().getString(R.string.movieProgressTitle)//
				, CineShowTimeMovieActivity.this.getResources().getString(R.string.movieProgressMsg) //
				, true, true, this);
	}
