...
import com.binomed.showtime.android.movieactivity.CineShowTimeMovieFragment.MovieFragmentInteraction;
import com.binomed.showtime.android.util.activity.AbstractSimpleCineShowTimeActivity;

public class CineShowTimeMovieActivity extends AbstractSimpleCineShowTimeActivity<CineShowTimeMovieFragment, ModelMovieActivity> //
		// public class CineShowTimeMovieActivity extends Activity //
		implements MovieFragmentInteraction //
// OnItemClickListener //
// , OnTabChangeListener //
// , OnTouchListener //
// , OnClickListener //
// , OnCancelListener //
{
	...
	// // tabHost.setup();
	//
	// Intent intentEmptyActivity = new Intent(CineShowTimeMovieActivity.this, EmptyActivity.class);
	//
	...
	// }
	//
	// projectionAdapter = new ProjectionListAdapter(CineShowTimeMovieActivity.this //
	// , movie //
	// , projectionList //
	...
	public void openDialog() {
		openDialog(R.string.movieProgressTitle, R.string.movieProgressMsg);
	}
