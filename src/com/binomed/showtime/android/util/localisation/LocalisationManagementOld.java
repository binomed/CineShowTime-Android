		...
		, IPLocationCallback //
{
	...
	public LocalisationManagementOld(Context context, ImageView imageGps, CheckBox chckBoxGps, AutoCompleteTextView textSearch, IModelLocalisation model) {
		super();
	...
	private void initListenersLocation() {
		if (checkboxPreference) {
			...
			LocationUtils.registerLocalisationListenerOld(context, provider, this);
		}
	...
	private void removeListenersLocation() {
		...
		LocationUtils.unRegisterListenerOld(context, provider, this);
	}
