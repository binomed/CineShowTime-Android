...
public class AndShowTimeWidgetHelper {
	...
	public static RemoteViews buildUpdate(Context context, Intent intent, TheaterBean theater, Map<MovieBean, ProjectionBean> movieBeanShowtimes) {
		...
		updateViews = new RemoteViews(context.getPackageName(), cupcake ? R.layout.and_showtime_widget_cupcake : R.layout.and_showtime_widget);
		updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_theater_title : R.id.widget_theater_title, (theater != null) ? theater.getTheaterName() : ""); //$NON-NLS-1$
		...
		if (movieBeanShowtimes.size() == 0) {
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_1 : R.id.widget_movie_txt_1, context.getResources().getString(((refresh) ? R.string.msgLoading : R.string.msgNoResults)));
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_1 : R.id.widget_movie_hour_1, ""); //$NON-NLS-1$
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_2 : R.id.widget_movie_txt_2, ""); //$NON-NLS-1$
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_2 : R.id.widget_movie_hour_2, ""); //$NON-NLS-1$
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_3 : R.id.widget_movie_txt_3, ""); //$NON-NLS-1$
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_3 : R.id.widget_movie_hour_3, ""); //$NON-NLS-1$
		} else {
			...
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_1 : R.id.widget_movie_txt_1, movieBean.getMovieName());
			ProjectionBean projectionTime = showTimeMap.get(movieBean.getId());
			updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_1 : R.id.widget_movie_hour_1, ((projectionTime.getLang() != null) ? projectionTime.getLang() + " " : "") + AndShowtimeDateNumberUtil.showMovieTime(context, projectionTime.getShowtime()));
			...
			updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake_group_movie_1 : R.id.widget_group_movie_1, pendingOpenMovieIntent1);
			if (size >= 2) {
				movieBean = movieList.get((start + 1) % size);
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_2 : R.id.widget_movie_txt_2, movieBean.getMovieName());
				projectionTime = showTimeMap.get(movieBean.getId());
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_2 : R.id.widget_movie_hour_2, ((projectionTime.getLang() != null) ? projectionTime.getLang() + " " : "") + AndShowtimeDateNumberUtil.showMovieTime(context, projectionTime.getShowtime()));
				...
				updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake_group_movie_2 : R.id.widget_group_movie_2, pendingOpenMovieIntent2);
			} else {
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_2 : R.id.widget_movie_txt_2, "");
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_2 : R.id.widget_movie_hour_2, "");

			}
			if (size >= 3) {
				movieBean = movieList.get((start + 2) % size);
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_3 : R.id.widget_movie_txt_3, movieBean.getMovieName());
				projectionTime = showTimeMap.get(movieBean.getId());
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_3 : R.id.widget_movie_hour_3, ((projectionTime.getLang() != null) ? projectionTime.getLang() + " " : "") + AndShowtimeDateNumberUtil.showMovieTime(context, projectionTime.getShowtime()));
				...
				updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake_group_movie_3 : R.id.widget_group_movie_3, pendingOpenMovieIntent3);
			} else {
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_txt_3 : R.id.widget_movie_txt_3, "");
				updateViews.setTextViewText(cupcake ? R.id.widget_cupcake_movie_hour_3 : R.id.widget_movie_hour_3, "");
		...
		PendingIntent pendingIntent = PendingIntent.getActivity(context, 0 /* no requestCode */, defineIntent, PendingIntent.FLAG_UPDATE_CURRENT);
		// PendingIntent pendingIntent = PendingIntent.getActivity(context, 0 /* no requestCode */, defineIntent, 0);
		updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake : R.id.widget, pendingIntent);
		...
		updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake_button_scroll_left : R.id.widget_button_scroll_left, pendingIntentScrollLeft);
		...
		updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake_button_scroll_right : R.id.widget_button_scroll_right, pendingIntentScrollRight);
		...
		updateViews.setOnClickPendingIntent(cupcake ? R.id.widget_cupcake_button_refresh : R.id.widget_button_refresh, pendingIntentScrollRefresh);
